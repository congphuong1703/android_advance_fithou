...
public class SecondaryDialView extends View {
     ...
     */
    public SecondaryDialView(Context context) {
        super(context);
        init(context, null);
    }
     ...
     */
    public SecondaryDialView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
     ...
     */
    public SecondaryDialView(Context context, AttributeSet attrs, int defStyleAttr) {
